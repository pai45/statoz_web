...
export const trendingMarkets: PickMarket[] = [
  ...
  { id: "epl_liv_mc_winner", sport: "football", leagueLabel: "EPL", question: "Liverpool vs Man City — full-time result?", outcomes: [{ id: "liv", label: "Liverpool", probabilityPercent: 41, delta: 7 }, { id: "draw", label: "Draw", probabilityPercent: 27, delta: -3 }, { id: "mci", label: "Man City", probabilityPercent: 32, delta: -4 }], volumeOz: 96500, resolved: false },
