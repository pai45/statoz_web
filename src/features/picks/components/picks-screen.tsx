...
export function PicksScreen() {
  ...
  return <main className={styles.page}>
    <div className={styles.header}><h1 className={styles.title}>ALL PICKS</h1><button type="button" className={styles.iconButton} aria-label="Filter and sort picks" onClick={() => setSettings(true)}>☷</button></div>
